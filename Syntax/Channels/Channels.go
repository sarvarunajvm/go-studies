...
func main() {
	...
	// and receiver are ready. This property allowed us to wait 
	// at the end of our program for the "ping" message without 
	...
	// Here we’ll receive the "ping" message we sent above and 
	// print it out.
    msg := <-messages
    fmt.Println(msg)
}